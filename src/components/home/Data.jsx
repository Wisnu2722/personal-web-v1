...
const Data = () => {
    return (
        <div className='home__data'>
            <h1 className="home__title">Wisnu Aditya &nbsp;
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">
                I&apos;m a web programmer based on Yogyakarta. I&apos;m enthusiastic web programmer, currently delving into JavaScript and mobile development. With extensive experience in web development, I design and implement responsive, user-friendly applications. Committed to ongoing learning, I believe in staying updated to provide optimal solutions for evolving challenges in the industry.
            </p>
